...
['skip','limit','order','sort'].forEach(function(method){
    AbstractClass[method] = function (key, value) {
        ...
        if(typeof value === 'undefined') {
            if(/^-/.test(key)) {
                this._params[method] = key.replace(/^-/,"") + ' DESC';
            } else {
                this._params[method] = key;
            }
        } else {
            this._params[method] = key + ' ' + value;
        }
        return this;
    };
});
...
['gt','gte','lt','lte','in','inq','ne','neq','nin','regex','like','nlike','between'].forEach(function(method){
    AbstractClass[method] = function (key, value) {
        if(typeof value === 'undefined') {
            if(this._pkey) {
                if(typeof this._conditions[this._pkey] == 'undefined') {
                    this._conditions[this._pkey] = {};
                }
                this._conditions[this._pkey][method] = key;
            }
        } else {
